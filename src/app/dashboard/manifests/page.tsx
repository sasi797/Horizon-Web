            ...
            <tbody className="divide-y divide-gray-50 dark:divide-navy-800/70">
              {manifests.map(m => (
                <tr key={m.id} className="hover:bg-gray-50/70 dark:hover:bg-navy-800/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-[12px] text-gray-700 dark:text-navy-300">{m.job_count}</td>
                  <td className="px-4 py-3 text-[12px] text-gray-700 dark:text-navy-300">{m.total_weight_kg}</td>
                  <td className="px-4 py-3 text-[11px] text-gray-500 dark:text-navy-500 whitespace-nowrap">
